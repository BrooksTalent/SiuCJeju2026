...
await write('journal.html',shell('五日旅行手帳',header('把日子，留在濟州','陪伴小詩的五日四夜生日自駕之旅')+'<div class="journal-content"><a class="wish-link" href="opening.html">給小詩的生日祝福 ♡</a><p class="route-caption">9月7日—11日 · RELAX & ROAD TRIP</p><div class="day-list">'+cards+'</div><div class="quick-grid"><a href="stay.html">⌂<strong>酒店・租車</strong><small>四晚住宿與出發時間</small></a><a href="weather.html">☀<strong>五日天氣</strong><small>出發前的預報快照</small></a><a href="food.html">♡<strong>想食清單</strong><small>喜歡的味道慢慢找</small></a><a href="notes.html">✎<strong>待確認事項</strong><small>集合點與行程小提醒</small></a></div><aside class="note"><h2>每天，留一點空白</h2><p>禪坐、寫感恩記、念幸福自在慈心禪。<br>不用固定時間，跟著當天的節奏就好。</p></aside></div>'));
